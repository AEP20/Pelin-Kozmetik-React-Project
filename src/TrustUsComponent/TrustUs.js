...
function TrustUs() {
  return (
    <div className="trust-us-dom-container">
      <div className="trust-us-title-container">
        <h1>Bize Güvenin</h1>
      </div>
      <div className="trust-us-container">
        <div className="trust-us-p-container">
          ...
          <p>
            GMP ve İSO belgelerimiz ve yüzlerce memnun müşterimizin de söylediği
            gibi Pelin Kozmetik içerik tariflerini gizli tutar, üretim ve
            teslimat sona erdikten sonra her şeyi ortadan kaldırır.
          </p>
        </div>
        <div className="trust-us-image-container">
